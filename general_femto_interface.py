...
"")
        ...
        self.one_fs_pushButton.setMaximumSize(QtCore.QSize(50, 16777215))
        font = QtGui.QFont()
        font.setFamily("Arial")
        ...
        self.pushButton.setStyleSheet("background-color: rgb(255, 200, 85);")
        self.pushButton.setObjectName("pushButton")
        self.horizontalLayout.addWidget(self.pushButton)
        self.five_fs_pushButton = QtWidgets.QPushButton(self.frame_6)
        self.five_fs_pushButton.setMaximumSize(QtCore.QSize(50, 16777215))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(10)
        font.setBold(True)
        ...
        self.pushButton_2.setStyleSheet("background-color: rgb(255, 200, 85);")
        self.pushButton_2.setObjectName("pushButton_2")
        self.horizontalLayout.addWidget(self.pushButton_2)
        self.ten_fs_pushButton = QtWidgets.QPushButton(self.frame_6)
        self.ten_fs_pushButton.setMaximumSize(QtCore.QSize(50, 16777215))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(10)
        font.setBold(True)
        ...
        self.pushButton_3.setStyleSheet("background-color: rgb(255, 200, 85);")
        self.pushButton_3.setObjectName("pushButton_3")
        self.horizontalLayout.addWidget(self.pushButton_3)
        self.twenty_fs_pushButton = QtWidgets.QPushButton(self.frame_6)
        self.twenty_fs_pushButton.setMaximumSize(QtCore.QSize(50, 16777215))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(10)
        font.setBold(True)
        ...
        self.pushButton_4.setStyleSheet("background-color: rgb(255, 200, 85);")
        ...
        self.set_zero_pushButton.setStyleSheet("background-color: rgb(255, 200, 85);")
    ...
    def retranslateUi(self, QMainWindow):
        ...
        self.pushButton.setText(_translate("QMainWindow", "-1 fs"))
        self.five_fs_pushButton.setText(_translate("QMainWindow", "5 fs"))
        self.pushButton_2.setText(_translate("QMainWindow", "-5 fs"))
        self.ten_fs_pushButton.setText(_translate("QMainWindow", "10 fs"))
        self.pushButton_3.setText(_translate("QMainWindow", "-10 fs"))
        self.twenty_fs_pushButton.setText(_translate("QMainWindow", "20 fs"))
        self.pushButton_4.setText(_translate("QMainWindow", "-20 fs"))
