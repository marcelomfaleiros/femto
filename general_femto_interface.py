...
"")
        ...
        self.sampl_time_label = QtWidgets.QLabel(self.frame_4)
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(11)
        font.setBold(True)
        font.setWeight(75)
        self.sampl_time_label.setFont(font)
        self.sampl_time_label.setObjectName("sampl_time_label")
        self.horizontalLayout_3.addWidget(self.sampl_time_label)
        self.sample_lineEdit = QtWidgets.QLineEdit(self.frame_4)
        self.sample_lineEdit.setStyleSheet("background-color: rgb(255, 255, 255);")
        self.sample_lineEdit.setObjectName("sample_lineEdit")
        self.horizontalLayout_3.addWidget(self.sample_lineEdit)
    ...
    def retranslateUi(self, QMainWindow):
        ...
        self.sampl_time_label.setText(_translate("QMainWindow", "Sampling time"))
